...
I chose this niche topic, as I collect many vinyl records, and I thought it would be a cool idea to incorporate my passion and hobby into this project.

This application uses CORS, which allows React to communicate with note, along with Axios on the server side to call the Discogs API server side.